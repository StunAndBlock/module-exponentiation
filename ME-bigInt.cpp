...
void BigInt::HexVersion(){
    ...
    hexTyped = "0x" + hexTyped;

}
 std::string BigInt::getHexTypedValue( BigInt& bigInt) const {
    ...
    while (n > 0) {
        ...
        char c = (r < 10) ? ('0' + r) : ('a' + r - 10);
        //hexadecimal digit added to start of the string
        bigInt.hexTyped = c + bigInt.hexTyped;
        n /= bb;
    }
    bigInt.hexTyped = "0x" + bigInt.hexTyped;
	return bigInt.hexTyped;
}
